            ...
            <div className="flex flex-col justify-center items-center h-[100vh] text-white" style={{ "background":" radial-gradient(circle at center, rgba(65,74,92,1) 5%, rgba(0,0,0,1) 80%)"}}>
                <div className="flex h-[80vh] flex-col justify-center px-6 py-12 lg:px-8 w-[25vw] bg-[rgba(0,0,0,0.5)] rounded-xl border-2 border-slate-600">
                    <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight ">Sign Up Now!</h2>
                    </div>
                    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm text-white">
                        <form className="space-y-6" onSubmit={handleSubmit(registerUser)}>
                            <label htmlFor="name" className="block text-sm font-medium leading-[0.25rem] ">Name : </label>
                            <div className="mt-2">
                                <input type="text" placeholder="Name" name="name" {...register("name", {required: true})} className="block w-full rounded-md border-0 py-1.5  shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 bg-slate-800 pl-2"/>
                            </div>
