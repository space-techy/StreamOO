...
const MoivePopup = () => {
  ...
  return (
    <>
        <div className="fixed top-0 left-0 right-0 bottom-0 h-screen w-screen bg-opacity-70 bg-black  text-white z-50 overflow-scroll scrollbar-hide">
            ...
            <div className='w-screen h-[10vh]'> 
                <div className='ml-[74vw] mt-[3vh]'>
                    <button className='absolute flex items-center justify-center  text-white px-4 py-2 w-[9vw]'>
